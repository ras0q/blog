...
export default (data: Lume.Data) => (
  <html lang="ja">
    ...
    <body class="font-sans prose max-w-full prose-neutral dark:prose-invert bg-neutral-50 dark:bg-neutral-700">
      <nav class="p-4xl flex justify-between view-transition-nav">
